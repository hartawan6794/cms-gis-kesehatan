...
class Rsia extends BaseController
{
	...
	public function getOne()
	{
		...
		if ($this->validation->check($id, 'required|numeric')) {
			...
			$data = $this->rsiaModel->where('id', $id)->first();
	...
	public function add()
	{
		...
		$this->validation->setRules([
			'nama' => ['label' => 'Nama rsia', 'rules' => 'required'],
	...
	public function edit()
	{
		...
		$data = $this->rsiaModel->select()->where('id', $fields['id'])->first();
		...
		if ($this->validation->run($fields) == FALSE) {
			...
			if ($this->rsiaModel->update($fields['id'], $fields)) {
	...
	public function remove()
	{
		...
		if (!$this->validation->check($id, 'required|numeric')) {
			...
			if ($this->rsiaModel->where('id', $id)->delete()) {
