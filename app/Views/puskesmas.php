    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="data-form" class="pl-3 pr-3">
          <div class="row">
            <input type="hidden" id="id_puskesmas" name="id_puskesmas" class="form-control" placeholder="Id puskesmas" maxlength="4" required>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="nama_puskesmas" class="col-form-label"> Nama puskesmas: <span class="text-danger">*</span> </label>
                <input type="text" id="nama_puskesmas" name="nama_puskesmas" class="form-control" placeholder="Nama puskesmas" minlength="0" maxlength="255" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
            ...
            <!-- <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="is_jadwal" class="col-form-label"> Jadwal: </label>
                <input type="number" id="is_jadwal" name="is_jadwal" class="form-control" placeholder="Jadwal" minlength="0" maxlength="3">
              </div>
            </div>
             -->
          </div>
...
<script>
  ...
  function save(id_puskesmas) {
    // reset the form 
    $("#data-form")[0].reset();
    $(".form-control").removeClass('is-invalid').removeClass('is-valid');
    if (typeof id_puskesmas === 'undefined' || id_puskesmas < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#data-modal').modal('show');
          //insert data to form
          $("#data-form #id_puskesmas").val(response.id_puskesmas);
          $("#data-form #nama_puskesmas").val(response.nama_puskesmas);
